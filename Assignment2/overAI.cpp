...
void OverAI::applyBoardChanges(int* old_board, int check1, int check2, int curr_pos, std::vector<int>* old_path) {
...
std::string OverAI::convert_array(int* board) {
...
void OverAI::printBoard(int* board) {
